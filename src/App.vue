...
<style>
@import url('https://fonts.googleapis.com/css2?family=Caveat:wght@600&family=Montserrat:ital@1&display=swap');
:root {
  --main-bg-color: #FAF3E3;
  --main-font-color: #000000;
  --btn-primary: #1A4D2E;
  --btn-secondary: #FF9F29;
  --white: #fff;
  --gray: #888;
}
* {
...
.button {
    ...
    display: block;
    padding: 0.5rem 1rem;
    background-image: linear-gradient(to right, var(--btn-primary) 50%, var(--btn-secondary) 50%);
    background-size: 200%;
    color: var(--white);
    font-size: 1.125rem;
    font-weight: bold;
